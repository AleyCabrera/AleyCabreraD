...
const certifications = [
    ...
    { name: "Procesos de soporte tecnico para el mantenimiento de equipos de computo", institution: "SENA", category: "sena", icon: "fas fa-tools", date: "2025", tags: ["Soporte Técnico", "Mantenimiento"], link: "/assets/doc/certificaciones/Proceso de Soporte Tecnico Para Mantenimiento de Equipos de Computo_page-0001.jpg", credentialId: "SENA-2025-001" },
    ...
    { name: "Aplicacion de la metodologia scrum para proyectos de desarrollo de software", institution: "SENA", category: "sena", icon: "fas fa-chart-line", date: "2024", tags: ["Scrum", "Ágil"], link: "#", credentialId: "SENA-2024-002" },
    { name: "Modulos, Estructura De Almacenamiento Y Poo Utilizando El Lenguaje De Programacion C++ (Nivel II)", institution: "SENA", category: "sena", icon: "fas fa-code", date: "2024", tags: ["C++", "POO", "Módulos"], link: "#", credentialId: "SENA-2024-003" },
    ...
    // SENA - 2023
    { name: "Metodologia de la programacion de sistemas informaticos", institution: "SENA", category: "sena", icon: "fas fa-code", date: "2023", tags: ["Programación", "Metodologías"], link: "#", credentialId: "SENA-2023-001" },
    { name: "Conceptualizacion del lenguaje de programacion C++", institution: "SENA", category: "sena", icon: "fas fa-code", date: "2023", tags: ["C++", "Programación"], link: "#", credentialId: "SENA-2023-002" },
    { name: "Estructura Del Lenguaje De Programacion C++ (Nivel I)", institution: "SENA", category: "sena", icon: "fas fa-code", date: "2023", tags: ["C++", "Estructuras"], link: "#", credentialId: "SENA-2023-003" },
